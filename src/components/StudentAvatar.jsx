...
function AnimalFace({ id }) {
  const commonFace = (
    <>
      ...
      <circle cx="19" cy="25" r="1.35" fill="currentColor" stroke="none" />
      <circle cx="29" cy="25" r="1.35" fill="currentColor" stroke="none" />
    </>
  );
  if (id === "dog")
    return (
      <>
        {commonFace}
        <path d="M12 19c-5-5-7 1-5 8 1 4 4 6 7 5M36 19c5-5 7 1 5 8-1 4-4 6-7 5" />
        <ellipse cx="24" cy="31" rx="4.5" ry="3.5" />
        <path d="M22 31h4M24 34v2" />
      </>
    );
  if (id === "penguin")
    return (
      <>
        <ellipse cx="24" cy="26" rx="13" ry="17" />
        <ellipse cx="24" cy="29" rx="8" ry="11" />
        <circle cx="20" cy="21" r="1.4" fill="currentColor" stroke="none" />
        <circle cx="28" cy="21" r="1.4" fill="currentColor" stroke="none" />
        <path d="m21 25 3 2 3-2-3-2-3 2ZM11 26l-5 7M37 26l5 7M18 42l-4 2M30 42l4 2" />
      </>
    );
  if (id === "fox")
    return (
      <>
        <path d="m11 10 9 5a15 15 0 0 1 8 0l9-5-2 17c-1 9-6 14-11 14s-10-5-11-14L11 10Z" />
        <circle cx="19" cy="25" r="1.35" fill="currentColor" stroke="none" />
        <circle cx="29" cy="25" r="1.35" fill="currentColor" stroke="none" />
        <path d="m17 31 7 6 7-6-7 2-7-2Z" />
      </>
    );
  if (id === "rabbit")
    return (
      <>
        <ellipse cx="18" cy="11" rx="5" ry="10" transform="rotate(-9 18 11)" />
        <ellipse cx="30" cy="11" rx="5" ry="10" transform="rotate(9 30 11)" />
        {commonFace}
        <path d="m22 31 2 2 2-2M24 33v4M20 36h8" />
      </>
    );
  if (id === "bear")
    return (
      <>
        ...
        {commonFace}
        <ellipse cx="24" cy="31" rx="5" ry="4" />
        <circle cx="24" cy="29.5" r="1.5" fill="currentColor" stroke="none" />
        <path d="M21 33c2 2 4 2 6 0" />
      </>
    );
  if (id === "frog")
    return (
      <>
        ...
        <path d="M11 19c-3 5-2 14 3 18 5 4 15 4 20 0 5-4 6-13 3-18" />
        <circle cx="16" cy="17" r="1.5" fill="currentColor" stroke="none" />
        <circle cx="32" cy="17" r="1.5" fill="currentColor" stroke="none" />
  ...
  if (id === "owl")
    return (
      <>
        <path d="M11 12c5 1 8 0 13-4 5 4 8 5 13 4v17c0 8-6 13-13 15-7-2-13-7-13-15V12Z" />
        ...
        <path d="m21 31 3 3 3-3-3-2-3 2Z" />
      </>
    );
  return (
    <>
      <path d="m12 21-2-12 12 7M36 21l2-12-12 7" />
      {commonFace}
      <path d="m22 31 2 2 2-2M24 33v3M11 29l-7-2M12 33l-7 2M37 29l7-2M36 33l7 2" />
    </>
  );
}
