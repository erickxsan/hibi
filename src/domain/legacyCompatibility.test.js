...
import { deriveAll, deserializeState, normalizeState, serializeState, validateState } from "./index";
...
describe("legacy workspace compatibility", () => {
  ...
  it("round-trips new individual and multiple-group records without changing relationships", () => {
    ...
    expect(restored.students[0]).toMatchObject({
      id: "student_legacy",
  ...
  it("keeps optional or incomplete legacy values valid and predictable", () => {
    const state = normalizeState({
      ...
      students: [
        legacyStudent({ groupId: "group_one", phone: undefined, guardianContact: undefined, notes: undefined }),
      ],
      grades: [],
      classLog: [],
    });
